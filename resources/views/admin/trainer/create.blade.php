    ...
    <div class="content-wrapper">
        <div class="card card-primary">
            <div class="card-title ml-4 mt-4">
                <h3 class="card-title">Add Traniner Form</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('admin.trainer.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="title">Trainer Name</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                            id="name" placeholder="Enter Trainer Name" value="{{ old('name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="" cols="20" rows="10"
                            placeholder="Enter Trainer Description" value="{{ old('description') }}"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('post') is-invalid @enderror" name="post"
                            id="post" placeholder="Enter post" value="{{ old('post') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('fee') is-invalid @enderror" name="fee"
                            id="fee" placeholder="Enter Fee" value="{{ old('fee') }}">
