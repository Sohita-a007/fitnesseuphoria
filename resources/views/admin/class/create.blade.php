                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control @error('title')  is-invalid @enderror"
                            name="title" id="title" placeholder="Enter Class Category" value="{{ old('title') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control  @error('subtitle') is-invalid @enderror" name="subtitle"
                            id="subtitle" placeholder="Enter Class Name" value="{{ old('subtitle') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="" cols="20" rows="10"
                            placeholder="Enter Class Description" value="{{ old('description') }}"></textarea>
